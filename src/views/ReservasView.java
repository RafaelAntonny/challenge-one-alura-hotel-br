...
public class ReservasView extends JFrame {
	...
	private void registro() throws SQLException {
		...
		Reserva novaReserva = new Reserva(java.sql.Date.valueOf(dataEntrada), java.sql.Date.valueOf(dataSaida), txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
		reservaController.salvar(novaReserva);
		
		JOptionPane.showMessageDialog(contentPane, "Registro salvo, Número de reserva " + Integer.toString(novaReserva.getId()));
